...
<body>
  ...
  <div class=" container bg-dark p-5 my-5 text-center">
    <h1 class="">Covid-19 Dashboard - Andhra Pradesh,India</h1>
    <h5 class="text-muted">
      Track all the COVID-19 cases within the Andhra-Pradesh territory.
    </h5>
  </div>
...
<br><div class="container" style="position: center;">
  <center>
<img class="responsive" src="../../img/andhra/a9.png">
</center>
</div><br>
  <!-- Bottom Note -->

          ...
          <div class="tab-pane" id="tab-4">
            <div class="row">
              <div class="col-lg-6 order-2 order-lg-1 mt-3 mt-lg-0">
                ...
                <ul>
                  <li><i class="ri-check-double-line"></i> Area Hospital, Macherla.[Macherla, Andhra Pradesh 522426]</li>
                  <li><i class="ri-check-double-line"></i> Markapuram Area Government hospital[Markapur, Andhra Pradesh 523329]</li>
                  <li><i class="ri-check-double-line"></i> Government Area Hospital[Palnadu Rd, Ameensaheb Palem, Arundelpet, Narasaraopeta, Andhra Pradesh 522601]</li>
                  <li><i class="ri-check-double-line"></i> Guntur Medical College[ Kanna Vari Thota, Guntur, Andhra Pradesh 522004]</li>
                </ul>
              </div>
              <div class="col-lg-6 order-1 order-lg-2 text-center">
                        ...
                        <div class="container box_1170">
                            ...
                            <div class="col-lg-12">
                                <h2 class="title-1 m-b-25" style="text-align: center;">Emergency Speciality Hospitals</h2>
                                 <?php
                                  $query = "SELECT * FROM healthcare WHERE state='andhrapradesh'";
...
<div class="container table-responsive">
  <h1 style="text-align: center;">HEALTH-CARE CENTERS IN ANDHRA PRADESH</h1>
  <center>
...
<script type="text/javascript">
  ...
  $.ajax({
    ...
    var newArray = covid_data.records.filter(function (el) {
      ...
      return el.state_name === 'Andhra Pradesh';

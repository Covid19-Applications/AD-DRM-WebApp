...
<br><br><br><br><br>
  ...
  <div class="whole-wrap">
                        <div class="container box_1170">
                            ...
                            <div class="col-lg-12">
                                <h2 class="title-1 m-b-25" style="text-align: center;">Hospitals In Andhra Pradesh</h2>
                                 <?php
                                  $query = "SELECT * FROM hosp_list WHERE state='andhrapradesh'";
                                    ...
                                    <table class="table table-borderless table-striped table-earning table table-hover"  id="state-wise">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th class="bg-primary">District/State</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                  <?php
